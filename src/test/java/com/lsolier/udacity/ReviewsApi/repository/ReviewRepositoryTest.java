...
public class ReviewRepositoryTest {
  ...
  public void testMethods(){
    ...
    product.setProductName("Nissan Test NUEVA LED");
    ...
    List<Review> actual = reviewRepository.findAllByProduct(product);
    AssertionsForClassTypes.assertThat(actual).isNotNull();
    Assert.assertEquals(product.getId(), actual.get(0).getId());

    Collection<Review> reviewCollection = reviewRepository.findAllReviewWhereProductNameContainsLed();
    AssertionsForClassTypes.assertThat(reviewCollection).isNotNull();
